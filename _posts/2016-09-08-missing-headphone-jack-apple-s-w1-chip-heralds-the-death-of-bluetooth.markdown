...
## Missing Headphone Jack!? Apple’s W1 chip heralds the death of Bluetooth

[Apple first wireless chip is the new W1 for wireless EarPods](http://www.theverge.com/2016/9/7/12829190/apple-w1-chip-iphone-7-wireless-headphones)
...
Which is to say, it’s not an interoperable product based on the [Bluetooth SIG](https://bluetooth.org)’s specifications and testing processes. Notorious for being “ [great next year](http://daringfireball.net/linked/2015/11/13/bluetooth-next-year)” and for vendors ignoring standard profiles in order to lock users of their hardware into their software, poor audio quality, flakey connections and an inability to synchronize with AirPlay due to a lack of timing signals. Bluetooth is basically the Android of Personal Area Networking, and it’s clear that Apple has had enough and want’s to move the ball into it’s own court.
...
*   [The iPhone 7 headphones savior won't be Bluetooth](http://www.slashgear.com/the-iphone-7-headphones-savior-wont-be-bluetooth-06454864/)
*   [Thinking more about Bluetooth 5's inclusion in the next iPhone](https://thinkerbit.com/articles/more-on-bluetooth-5-in-next-iphone)
